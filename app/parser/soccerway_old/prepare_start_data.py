...
def main():
    ...
    for ii in date_list:
        ...
        response = do_response("https://ru.soccerway.com/matches/" + date, False)
        soup = BeautifulSoup(response.content, "lxml")
        base_link = "https://ru.soccerway.com"
        i = 0
        ...
        for line in file_pointer:
            ...
            link = "https://ru.soccerway.com/a/block_date_matches?" + (urllib.parse.urlencode(get_params))
