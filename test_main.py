...
def test_run_soccerway1_valid(mock_delay):
    ...
    response = client.post("/api/run/soccerway1", params={"date_start": "2024-08-09", "date_end": "2024-12-23"})
...
def test_run_soccerway2_valid(mock_delay):
    ...
    response = client.post("/api/run/soccerway2", params={"date_start": "2024-08-09", "date_end": "2024-12-23"})
